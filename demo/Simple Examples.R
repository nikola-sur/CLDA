...
mod_L2 <- CLDA::CLDA(x = x, y = y, linear = TRUE, type = "compressed", m = m, s = 0.01, gamma = 1e-4)
mod_L3 <- CLDA::CLDA(x = x, y = y, linear = TRUE, type = "projected", m = m, s = 0.01, gamma = 1e-4)
mod_L4 <- CLDA::CLDA(x = x, y = y, linear = TRUE, type = "subsampled", m = m, gamma = 1e-4)
mod_L5 <- CLDA::CLDA(x = x, y = y, linear = TRUE, type = "FRF", m = m, s = 0.01, gamma = 1e-4)

mod_Q1 <- CLDA::CLDA(x = x, y = y, linear = FALSE, type = "full", gamma = 1e-4)
mod_Q2 <- CLDA::CLDA(x = x, y = y, linear = FALSE, type = "compressed", m = m, s = 0.01, gamma = 1e-4)
mod_Q3 <- CLDA::CLDA(x = x, y = y, linear = FALSE, type = "subsampled", m = m, gamma = 1e-4)
...
preds_Q3 <- predict.CLDA(mod = mod_Q3, x = x_test)
