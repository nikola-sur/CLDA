...
```{r}
s <- 0.01
gamma <- 1e-4 # Original study suggests 1e-4, but this did not work
m_vec <- c(250L, 500L, 1000L, 2000L) # c(250L, 500L, 1000L, 2000L)
num_reps <- 10L # Number of simulations for a given value of 'm'; 100L
...
```{r}
plot.CLDA(data = sim_data, light_theme = TRUE)
```
